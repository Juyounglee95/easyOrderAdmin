...
export class NearbyPage {
    ...
    constructor(public navCtrl: NavController, private alertCtrl: AlertController,public service: RestaurantService, public modalCtrl: ModalController, public navParams: NavParams) {
